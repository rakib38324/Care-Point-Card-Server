 ...
 */
const openEnrollmentPeriodSchema = new Schema(
  {
 ...
 */
const employerApplicationSchema = new Schema<TEmployerApplication>(
  {
 ...
 * ================= Model Export =================
 */
export const EmployerApplication = model<TEmployerApplication>(
  'EmployerApplication',
